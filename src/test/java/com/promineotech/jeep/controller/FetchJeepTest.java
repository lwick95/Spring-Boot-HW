...
//  @Autowired
//  private TestRestTemplate restTemplate;  //this and LocalServerPort might need moved up?
//  
//  @LocalServerPort
...
// 
  ...
  class TestsThatDoNotPolluteTheApplicationCentext{
...
class TestsThatPolluteTheApplicationCentext{
    @Autowired
    private TestRestTemplate restTemplate;  //this and LocalServerPort might need moved up?
...
//    @Test
//    void testThatAnUnplannedErrorResultsInA500AStatus() {
//      //Given: a valid model, trim URI
//      JeepModel model = JeepModel.WRANGLER;
//      String trim = "Invalid";
//      String uri = String.format("http://localhost:%d/jeeps?model=%s&trim=%s", serverPort, model, trim);
