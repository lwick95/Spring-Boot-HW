...
//        jeepOrderDao.fetchCustomer(orderRequest.getCustomer())
...
//        + orderRequest.getTire()+ "was not found"));
    ...
    BigDecimal price = jeep.getBasePrice().add(color.getPrice()).add(engine.getPrice())
        .add(tire.getPrice());
